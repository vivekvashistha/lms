...
class UserController extends Controller
{
    ...
    {
        return $this->userService->getUsersDatatables();
    }
    ...
    public function makeApprove($user)
    {
        $user = User::find($user);
        //dd($user);
        $user->approved = 'A';
        ...
        $user->save();
        return redirect()->route('admin.auth.user.index')->withFlashSuccess(__('The user was successfully Approved.'));
    }
}
