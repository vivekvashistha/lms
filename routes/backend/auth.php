...
Route::group([
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::get('makeApprove/{user}', [UserController::class, 'makeApprove'])->name('makeApprove');
        ...
        Route::group([
            ...
            Route::get('getUsers', [UserController::class, 'getUsers'])
                ...
                ->breadcrumbs(function (Trail $trail) {
                    $trail->parent('admin.dashboard')
                        ->push(__('User Management'), route('admin.auth.user.usersdtindex'));
                });  
	...
	Route::get('/Instructor', [UserController::class, 'index'])
                ->name('indexInstructor');
//	Route::group([
//        'prefix' => 'pages',
//        'as' => 'pages.',
//        //'middleware' => 'pages:'.config('boilerplate.access.pages.admin'),
//    ], function () {
...
//                    $trail->parent('admin.page.pages.index')
//                        ->push(__('Editing :pages', ['pages' => $pages->name]), route('admin.page.pages.edit', $pages));
//                });
//
